...
int main()
{
    ...
    cout << "Введите размеры блоков (ширина, высота):"<< endl;
    for(int i = 0; i < n; i++)
    {
        int width, height;
        cin >> width >> height;
    ...
    // Сортировка блоков по убыванию ширины (при равной ширине — по убыванию высоты)
    ...
    cout << "Наибольшая высота пирамиды: " << resultHeight << endl;
}
